...
public class AcoesBatalha {
            ...
            if (DadosLivroCarregado.getPersonagem().getSorteAtual() > 0) {
                ...
                if (TelaBatalha.isRespostaTelaConfirmacao()) {
                    ...
                    if (resultadoSorte) {
                        ...
                        util.reproduzirAudioMp3("audio/efeitos_sonoros/azar.mp3", null);
    ...
    public ResultadoBatalha turnoDeBatalha() {
        ...
        util.reproduzirAudioMp3("audio/efeitos_sonoros/calculo_ataque.mp3", null);
        ...
        switch ( telaSecao.getSecao().getCodSecaoLivro() ){
            ...
            case 352 -> desvantagem = desvantagem2pontosNoAtque();  //O personagem tem desvantagem na luta de -2 pontos de ataque
        }
        ...
        util.reproduzirAudioMp3("audio/efeitos_sonoros/resultado_turno_batalha.mp3", null);
        if (forcaDeAtaquePersonagem > forcaDeAtaqueInimigo){
            ...
            if ( !inimigoVivo ){
                ...
                util.reproduzirAudioMp3("audio/efeitos_sonoros/vitoria.mp3", null);
        ...
        /// INIMIGO GANHA TURNO DE BATALHA
            ...
            util.reproduzirAudioMp3("audio/efeitos_sonoros/dor.mp3", null);
        ...
        ///EMPATE
            ...
            util.reproduzirAudioMp3("audio/efeitos_sonoros/empate.mp3", null);
    ...
    private int desvantagem2pontosNoAtque(){
        mensagemComDelay(milisegundos,"<html><center>-2 pontos na sua Força de Ataque</center></html>");
        return 2;
    }
    ...
    public ResultadoBatalha testarSorte(ResultadoBatalha resultadoBatalha){
        ...
        if ( resultadoBatalha == ResultadoBatalha.PERSONAGEM_GANHOU_TURNO ){
            //util.reproduzirAudioMp3("audio/efeitos_sonoros/rolar_dados.mp3", null);
