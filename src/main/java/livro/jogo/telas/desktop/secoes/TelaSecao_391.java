...
import livro.jogo.acaosecoes.AcoesSecao_391;
...
public class TelaSecao_391 extends TelaSecoesBasica {
    boolean possuiChaveDePrata;

    public TelaSecao_391(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                possuiChaveDePrata = AcoesSecao_391.verificaSePossuiPocaoCurativa();
            }
    ...
    protected void acaoBotoes(Secao secao) {
        botaoOpcao1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (possuiChaveDePrata)
                    abrirProximaSecao( secao.getProximasSecoes().getFirst().getCodProximaSecao() );
                else
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome() +
                            ",\n\nvocê não possui uma chave de prata." +
        ...
        botaoOpcao2.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ( !possuiChaveDePrata)
                    ...
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nProcure em sua bolsa, eu acho que você tem uma Chave de Prata!");
            }
