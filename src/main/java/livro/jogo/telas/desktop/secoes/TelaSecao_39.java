...
import livro.jogo.acaosecoes.AcoesSecao_39;
...
public class TelaSecao_39 extends TelaSecoesBasica {
    public TelaSecao_39(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_39.usaRedeDeAprisionamento();
            }
