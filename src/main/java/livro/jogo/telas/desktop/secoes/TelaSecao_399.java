...
public class TelaSecao_399 extends TelaSecoesBasica {
    public TelaSecao_399(Secao secao) {
        super(secao);

        new Util().reproduzirAudioMp3("livros/florestadadestruicao/audio/efeitos_sonoros/sapo.mp3", null);
    }
