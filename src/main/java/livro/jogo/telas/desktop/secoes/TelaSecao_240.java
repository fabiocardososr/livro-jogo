...
import livro.jogo.acaosecoes.AcoesSecao_240;
...
public class TelaSecao_240 extends TelaSecoesBasica {
    boolean possuiFiltrosNasais;
    public TelaSecao_240(Secao secao) {
        super(secao);
        ...
        botaoOpcao2.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ( !possuiFiltrosNasais )
                    ...
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nProcure em sua bolsa, eu acho que você tem Filtros Nasais!");
            }
