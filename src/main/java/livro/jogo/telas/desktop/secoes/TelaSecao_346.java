...
import livro.jogo.acaosecoes.AcoesSecao_346;
...
public class TelaSecao_346 extends TelaSecoesBasica {
    public TelaSecao_346(Secao secao) {
        super(secao);
    }
    ...
    protected void acaoBotoes(Secao secao) {
        botaoOpcao1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if ( AcoesSecao_346.possui10MoedasEMaisQue2Itens() )
                    abrirProximaSecao( secao.getProximasSecoes().getFirst().getCodProximaSecao() );
                else
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nArragon exige 10 moedas e 2 itens, mas você não possui o suficiente.\n\nPortanto, escolha a outra opção.");
            }
