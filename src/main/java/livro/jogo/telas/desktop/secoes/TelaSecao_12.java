...
public class TelaSecao_12 extends TelaSecoesBasica {
    ...
    private void carregaBotaoOpcaoMoedas() {
        ...
        //Botão
        JLabelOpcoesTelaSecao botao = new JLabelOpcoesTelaSecao("",400, 100,
                ImagensDoLivroFlorestaDaDestruicao.FAIXA_OPCOES.getEnderecoImagem());
        botao.setBounds(100,560,400,100);
        ...
        //Texto
        JLabel textoComecarJornada = new JLabel("<html><center>Pagar as 10 moedas</center></html>");
        textoComecarJornada.setBounds(120,580,360,60);
