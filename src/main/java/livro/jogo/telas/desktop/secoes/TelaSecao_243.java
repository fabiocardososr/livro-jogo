...
import livro.jogo.acaosecoes.AcoesSecao_243;
...
public class TelaSecao_243 extends TelaSecoesBasica {
    public TelaSecao_243(Secao secao) {
        super(secao);
    }
    ...
    protected void acaoBotoes(Secao secao) {
        botaoOpcao1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ( AcoesSecao_243.verificaSePossuiMoedas() )
                    abrirProximaSecao( secao.getProximasSecoes().getFirst().getCodProximaSecao() );
                else
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nVocê não possui moeda para doar ao frade.");
