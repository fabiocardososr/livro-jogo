...
import livro.jogo.acaosecoes.AcoesSecao_336;
...
public class TelaSecao_336 extends TelaSecoesBasica {
    boolean possuiPocaoAntiveneno;

    public TelaSecao_336(Secao secao) {
        super(secao);
        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                possuiPocaoAntiveneno = AcoesSecao_336.verificaSePossuiPocaoAntiveneno();
            }
        ...
        botaoOpcao2.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ( !possuiPocaoAntiveneno)
                    ...
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nProcure em sua bolsa, acho que você tem uma Poção Antiveneno!");
            }
