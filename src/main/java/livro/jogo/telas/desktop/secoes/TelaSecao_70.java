...
import livro.jogo.acaosecoes.AcoesSecao_70;
...
public class TelaSecao_70 extends TelaSecoesBasica {
    public TelaSecao_70(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_70.equiparEspadaMagnifica(secao);
