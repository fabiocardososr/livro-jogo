...
import livro.jogo.acaosecoes.AcoesSecao_319;
...
public class TelaSecao_319 extends TelaSecoesBasica {
    boolean possuiBotasSaltadoras;

    public TelaSecao_319(Secao secao) {
        super(secao);
        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                possuiBotasSaltadoras = AcoesSecao_319.verificaSePossuiBotasSaltadoras();
            }
    ...
    protected void acaoBotoes(Secao secao) {
        botaoOpcao1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (possuiBotasSaltadoras)
                    abrirProximaSecao( secao.getProximasSecoes().getFirst().getCodProximaSecao() );
                else
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome() +
                            ",\n\nvocê não possui Botas Saltadoras." +
        ...
        botaoOpcao2.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ( !possuiBotasSaltadoras)
                    ...
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nProcure em sua bolsa, eu acho que você tem uma Bota Saltadora!");
            }
