...
public class TelaSecao_190 extends TelaSecoesBasica {
    public TelaSecao_190(Secao secao) {
        super(secao);
        new Util().reproduzirAudioMp3("audio/efeitos_sonoros/passos_floresta.mp3", null);
    }
