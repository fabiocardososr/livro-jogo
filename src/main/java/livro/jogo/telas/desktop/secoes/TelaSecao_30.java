...
public class TelaSecao_30 extends TelaSecoesBasica {
    public TelaSecao_30(Secao secao) {
        super(secao);
        ...
        addWindowListener(new WindowListener() {
            ...
            public void windowOpened(WindowEvent e) {
                ...
                if ( !AcoesSecao_30.perde2PontosDeEnergiaEverificaSePersonagemVivo() ){
        ...
        botaoOpcao1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getSource() == botaoOpcao1){
                    ...
                    //Se personagem vivo após a perda 2 pontos de energia, libera a próxima seção
