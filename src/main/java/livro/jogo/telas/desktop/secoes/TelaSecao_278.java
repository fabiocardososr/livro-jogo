...
import livro.jogo.acaosecoes.AcoesSecao_278;
...
public class TelaSecao_278 extends TelaSecoesBasica {
    boolean testouSorte = false;
    JLabel textoBotaoTesteSorte;

    public TelaSecao_278(Secao secao) {
        super(secao);
        new Util().reproduzirAudioMp3("audio/efeitos_sonoros/caindo.mp3", null);
    }
