...
import livro.jogo.acaosecoes.AcoesSecao_259;
...
public class TelaSecao_259 extends TelaSecoesBasica {
    boolean testouSorte = false;
    JLabel textoBotaoTesteSorte;

    public TelaSecao_259(Secao secao) {
        super(secao);
        ...
        addWindowListener(new WindowListener() {
            ...
            public void windowOpened(WindowEvent e) {
                ...
                personagemVivo( AcoesSecao_259.perde3PontosDeEnergia() );
    ...
    private void testarSorte(){
        ...
        if ( Util.testarSorte() ){
            ...
            CarregarTelas.telaMensagem("Azarado!\nVocê foi malsucedido no teste de sorte.\nVocê fica apavorado e devido ao choque perde mais 2 pontos de energia.");
            //Se personagem morto, fecha a tela de seção e abre a principal
            personagemVivo( AcoesSecao_259.perde2PontosDeEnergia() );
            //Atualiza label que mostra os níveis de habilidade, sorte e energia do personagem na tela
            atualizaIndicesNaTelaDoPersonagem();
