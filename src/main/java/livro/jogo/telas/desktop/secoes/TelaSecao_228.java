...
import livro.jogo.acaosecoes.AcoesSecao_228;
...
public class TelaSecao_228 extends TelaSecoesBasica {
    public TelaSecao_228(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_228.equiparBotasSaltadoras();
            }
