...
import livro.jogo.acaosecoes.AcoesSecao_338;
...
public class TelaSecao_338 extends TelaSecoesBasica {
    public TelaSecao_338(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_338.colocaCaixaNaBolsa();
            }
