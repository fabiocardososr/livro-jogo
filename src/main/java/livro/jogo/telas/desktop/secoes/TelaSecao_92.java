...
import livro.jogo.acaosecoes.AcoesSecao_64;
import livro.jogo.acaosecoes.AcoesSecao_92;
...
public class TelaSecao_92 extends TelaSecoesBasica {
    public TelaSecao_92(Secao secao) {
        super(secao);
    }
        ...
        botaoOpcao3.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getSource() == botaoOpcao3){
                    if ( AcoesSecao_92.consumirPocaoControlePlantas() )
                      abrirProximaSecao( secao.getProximasSecoes().get(2).getCodProximaSecao() );
                    else
                        CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                                ",\n\nvocê não tem a Poção de Controle dos Insetos."+
