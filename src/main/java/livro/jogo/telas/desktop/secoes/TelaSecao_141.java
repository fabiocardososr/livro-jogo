...
import livro.jogo.acaosecoes.AcoesSecao_141;
...
public class TelaSecao_141 extends TelaSecoesBasica {
    public TelaSecao_141(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_141.perde1PontoDeSorte();
