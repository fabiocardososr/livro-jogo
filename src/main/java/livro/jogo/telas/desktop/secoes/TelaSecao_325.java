...
import livro.jogo.acaosecoes.AcoesSecao_325;
...
public class TelaSecao_325 extends TelaSecoesBasica {
    boolean possuiCabecaDeAlho;

    public TelaSecao_325(Secao secao) {
        super(secao);
    ...
    protected void acaoBotoes(Secao secao) {
        botaoOpcao1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (possuiCabecaDeAlho)
                    abrirProximaSecao( secao.getProximasSecoes().getFirst().getCodProximaSecao() );
                else
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nvocê não possui uma cabeça de alho.");
            }
        ...
        botaoOpcao2.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ( !possuiCabecaDeAlho)
                    ...
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nProcure em sua bolsa, acho que você tem uma Cabeça de alho.");
            }
