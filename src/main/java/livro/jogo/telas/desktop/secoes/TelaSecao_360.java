...
import livro.jogo.acaosecoes.AcoesSecao_360;
...
public class TelaSecao_360 extends TelaSecoesBasica {
    public TelaSecao_360(Secao secao) {
        super(secao);
    }
    ...
    protected void acaoBotoes(Secao secao) {
        botaoOpcao1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (AcoesSecao_360.verificaSePossuiItensOuMoedasParaPagar() )
                    abrirProximaSecao(secao.getProximasSecoes().getFirst().getCodProximaSecao());
                else
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome()+
                            ",\n\nVocê não possui 5 itens para pagar a mulher e seus bandidos.");
            }
