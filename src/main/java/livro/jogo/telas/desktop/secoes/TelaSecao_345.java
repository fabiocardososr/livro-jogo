...
import livro.jogo.acaosecoes.AcoesSecao_345;
...
public class TelaSecao_345 extends TelaSecoesBasica {
    public TelaSecao_345(Secao secao) {
        super(secao);
        addWindowListener(new WindowListener() {
            ...
            public void windowOpened(WindowEvent e) {
                ...
                personagemVivo(AcoesSecao_345.perde4PontosDeEnergia() );
