...
import livro.jogo.acaosecoes.AcoesSecao_311;
import livro.jogo.acaosecoes.AcoesSecao_312;
...
public class TelaSecao_312 extends TelaSecoesBasica {
    public TelaSecao_312(Secao secao) {
        super(secao);
        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_312.pegar25moedasDeOuro();
                AcoesSecao_312.ganharCabecaDeMartelo();
