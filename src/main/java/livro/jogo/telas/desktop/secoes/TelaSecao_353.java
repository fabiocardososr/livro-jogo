...
import livro.jogo.acaosecoes.AcoesSecao_299;
import livro.jogo.acaosecoes.AcoesSecao_353;
...
public class TelaSecao_353 extends TelaSecoesBasica {
    public TelaSecao_353(Secao secao) {
        super(secao);
        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_353.perdeTodasAsProvisoes();
