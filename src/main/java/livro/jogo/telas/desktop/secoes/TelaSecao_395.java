...
import livro.jogo.acaosecoes.AcoesSecao_395;
...
public class TelaSecao_395 extends TelaSecoesBasica {
    boolean testouSorte = false;
    JLabel textoBotaoTesteSorte;

    public TelaSecao_395(Secao secao) {
        super(secao);
    }
    ...
    private void testarSorte(){
        ...
        if ( Util.testarSorte() ){
            ...
            personagemVivo( AcoesSecao_395.perde3PontosDeEnergia() );
