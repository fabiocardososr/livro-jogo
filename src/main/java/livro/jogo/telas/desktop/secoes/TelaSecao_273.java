...
import livro.jogo.acaosecoes.AcoesSecao_273;
...
public class TelaSecao_273 extends TelaSecoesBasica {
    public TelaSecao_273(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_273.pegarMedalhao();
            }
