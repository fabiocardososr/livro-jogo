...
import livro.jogo.acaosecoes.AcoesSecao_295;
...
public class TelaSecao_295 extends TelaSecoesBasica {
    boolean possuiEmo;

    public TelaSecao_295(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                possuiEmo = AcoesSecao_295.verificaSePossuiElmo();
            }
