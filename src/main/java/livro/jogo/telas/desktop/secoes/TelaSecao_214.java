...
import livro.jogo.acaosecoes.AcoesSecao_214;
...
public class TelaSecao_214 extends TelaSecoesBasica {
    public TelaSecao_214(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_214.bebePocaoCurativa();
            }
