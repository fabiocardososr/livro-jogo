...
import livro.jogo.acaosecoes.AcoesSecao_302;
...
public class TelaSecao_302 extends TelaSecoesBasica {
    public TelaSecao_302(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                AcoesSecao_302.equiparPulseiraDeHabilidade();
            }
