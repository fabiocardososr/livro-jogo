...
public class TelaSecao_303 extends TelaSecoesBasica {
    public TelaSecao_303(Secao secao) {
        super(secao);

        addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
                new Util().reproduzirAudioMp3("audio/efeitos_sonoros/piterodactilo.mp3", null);
            }
