...
import livro.jogo.acaosecoes.AcoesSecao_120;
...
public class TelaSecao_120 extends TelaSecoesBasica {
    private boolean possuiCordaDeEscalada;
    ...
    public TelaSecao_120(Secao secao) {
        ...
        addWindowListener(new WindowListener() {
            ...
            public void windowOpened(WindowEvent e) {
                possuiCordaDeEscalada = AcoesSecao_120.verificaSePossuiCordaDeEscalada();
            }
    ...
    protected void acaoBotoes(Secao secao) {
        botaoOpcao1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ( possuiCordaDeEscalada )
                    abrirProximaSecao( secao.getProximasSecoes().getFirst().getCodProximaSecao() );
                else
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome() +
                            ",\n\nvocê não possui uma Corda de Escalada." +
                            "\n\nPoderia ter adquirido com o velho Yaztromo quando teve oportunidade.");
        ...
        botaoOpcao2.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (possuiCordaDeEscalada) {
                    CarregarTelas.telaMensagem(DadosLivroCarregado.getPersonagem().getNome() +
                            ",\n\nvocê possui uma Corda de Escalada, encontra-se em sua bolsa." +
                            "\n\nPrefere não usá-la?", tela);
                }

                if ( (!possuiCordaDeEscalada) || (isRespostaTelaMensagem()) )
