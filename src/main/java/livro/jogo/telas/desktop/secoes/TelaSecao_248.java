...
import livro.jogo.acaosecoes.AcoesSecao_232;
import livro.jogo.acaosecoes.AcoesSecao_248;
...
public class TelaSecao_248 extends TelaSecoesBasica {
    public TelaSecao_248(Secao secao) {
        super(secao);
