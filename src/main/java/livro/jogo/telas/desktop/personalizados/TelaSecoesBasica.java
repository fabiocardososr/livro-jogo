    ...
    private void carregarEscolhaDeItens(Secao secao) {
        ...
        if (secao != null){
            ...
            switch (secao.getCodSecaoLivro()){
                case 14,129,218,242,271,370: carregaListaDeItensNaBolsaQuePodemSerEntregues(80,430,400,190,1);
                    break;
...
//                return button;
    ...
    protected void ajustarOpcoesSecao(int numeroDeOpcoes){
        switch (numeroDeOpcoes){
            case -1: carregaBotaoOpcaoInicio();
                break;
            case 1:
                ajustar1opcao();
                break;
    ...
    private void carregaBotaoOpcaoInicio() {
