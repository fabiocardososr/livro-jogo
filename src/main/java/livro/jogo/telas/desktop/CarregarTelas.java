...
public class CarregarTelas {
    ...
    public static void carregarSecao(Secao secao){
        ...
        switch ( secao.getCodSecaoLivro() ){
            ...
            case 65  -> new TelaSecao_65(secao).setVisible(true); //Chamado por 299
            ...
            case 85  -> new TelaSecao_85(secao).setVisible(true); //chamado por 169,313
            case 86  -> new TelaSecao_86(secao).setVisible(true);
            case 87  -> new TelaSecao_87(secao).setVisible(true); //Chamado por 198
            case 88  -> new TelaSecao_88(secao).setVisible(true); //Chamado por 201,249,293
            ...
            case 102 -> new TelaSecao_102(secao).setVisible(true); //Chamado por 323
            ...
            case 112 -> new TelaSecao_112(secao).setVisible(true); //chamado pela seção 58,73,200,292,306,312,327
            ...
            case 133 -> new TelaSecao_133(secao).setVisible(true); //Chamado por 305 - Coloca anel no dedo(Anel da Lentidão)
            ...
            case 163 -> new TelaSecao_163(secao).setVisible(true);//chamado pela seção 56,245,281
            ...
            case 215 -> new TelaSecao_215(secao).setVisible(true); //Chamado por 293
            ...
            case 231 -> new TelaSecao_231(secao).setVisible(true); //chamado pela seção 34,154,318
            ...
            case 280 -> new TelaSecao_280(secao).setVisible(true);
            ...
            case 288 -> new TelaSecao_288(secao).setVisible(true); //Chamado por 294,314
            ...
            case 291 -> new TelaSecao_291(secao).setVisible(true);//chamado pela seção 208,323
            ...
            case 320 -> new TelaSecao_320(secao).setVisible(true);
            ...
            case 326 -> new TelaSecao_326(secao).setVisible(true);
            ...
            case 351 -> new TelaSecao_351(secao).setVisible(true); //Chamado por 200,327
            ...
            case 354 -> new TelaSecao_354(secao).setVisible(true);//chamado pela seção 266
            ...
            case 358 -> new TelaSecao_358(secao).setVisible(true);//chamado pela seção 22,55,85,168,169,176,230,232,263,290,313
            case 359 -> new TelaSecao_359(secao).setVisible(true);//chamado pela seção 188
            case 360 -> new TelaSecao_360(secao).setVisible(true); //chamado pela seção 103,133,305 (4 homens e 1 mulher)
            ...
            case 374 -> new TelaSecao_374(secao).setVisible(true); //chamado pela seção 133,305
