...
public class CarregarTelas {
    ...
    public static void carregarSecao(Secao secao){
        ...
        switch ( secao.getCodSecaoLivro() ){
            ...
            case 88  -> new TelaSecao_88(secao).setVisible(true); //Chamado por 201
            ...
            case 149 -> new TelaSecao_149(secao).setVisible(true);//chamado pela seção 13,113,185
            case 150 -> new TelaSecao_150(secao).setVisible(true);//chamado pela seção 32,111,223
            ...
            case 204 -> new TelaSecao_204(secao).setVisible(true); //Verifica se possui todas as partes do martelo
            ...
            case 214 -> new TelaSecao_214(secao).setVisible(true); //Consome Poção Curativa(27)
            ...
            case 219 -> new TelaSecao_219(secao).setVisible(true); //Ganha dardo de prata e sorte
            case 220 -> new TelaSecao_220(secao).setVisible(true);//chamado pela seção 26,38,47,147
            case 221 -> new TelaSecao_221(secao).setVisible(true);//chamado pela seção 188
            ...
            case 332 -> new TelaSecao_332(secao).setVisible(true);//chamado pela seção 224
            ...
            case 358 -> new TelaSecao_358(secao).setVisible(true);//chamado pela seção 22,55,85,168,169,176,230
            ...
            case 382 -> new TelaSecao_382(secao).setVisible(true);//chamado pela seção 204
            ...
            case 389 -> new TelaSecao_389(secao).setVisible(true);//chamado pela seção 201
